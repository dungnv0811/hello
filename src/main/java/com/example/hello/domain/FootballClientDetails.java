...
@Document
@Data
public class FootballClientDetails implements ClientDetails {
    ...
    public FootballClientDetails(final String clientId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FootballClientDetails)) return false;

        FootballClientDetails that = (FootballClientDetails) o;
