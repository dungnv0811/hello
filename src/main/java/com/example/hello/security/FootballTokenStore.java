...
import com.example.hello.repository.user.FootballOAuth2AccessTokenRepository;
import com.example.hello.repository.user.FootballOAuth2RefreshTokenRepository;
...
@Component
public class FootballTokenStore implements TokenStore {

    private final FootballOAuth2AccessTokenRepository mongoOAuth2AccessTokenRepository;

    private final FootballOAuth2RefreshTokenRepository mongoOAuth2RefreshTokenRepository;

    private final AuthenticationKeyGenerator authenticationKeyGenerator;

    public FootballTokenStore(final FootballOAuth2AccessTokenRepository mongoOAuth2AccessTokenRepository,
                           final FootballOAuth2RefreshTokenRepository mongoOAuth2RefreshTokenRepository,
    ...
    public OAuth2Authentication readAuthentication(final String token) {
        ...
        final FootballOAuth2AccessToken mongoOAuth2AccessToken = mongoOAuth2AccessTokenRepository.findByTokenId(tokenId);
    ...
    public void storeAccessToken(final OAuth2AccessToken token,
        ...
        final FootballOAuth2AccessToken oAuth2AccessToken = new FootballOAuth2AccessToken(tokenKey,
    ...
    public OAuth2AccessToken readAccessToken(final String tokenValue) {
        ...
        final FootballOAuth2AccessToken mongoOAuth2AccessToken = mongoOAuth2AccessTokenRepository.findByTokenId(tokenKey);
        if (nonNull(mongoOAuth2AccessToken)) {
            try {
    ...
    public void storeRefreshToken(final OAuth2RefreshToken refreshToken,
        ...
        final FootballOAuth2RefreshToken oAuth2RefreshToken = new FootballOAuth2RefreshToken(tokenKey, token, authentication);
    ...
    public OAuth2RefreshToken readRefreshToken(final String tokenValue) {
        final String tokenKey = extractTokenKey(tokenValue);
        final FootballOAuth2RefreshToken mongoOAuth2RefreshToken = mongoOAuth2RefreshTokenRepository.findByTokenId(tokenKey);
    ...
    public OAuth2AccessToken getAccessToken(final OAuth2Authentication authentication) {
        ...
        final FootballOAuth2AccessToken oAuth2AccessToken = mongoOAuth2AccessTokenRepository.findByAuthenticationId(key);
    ...
    public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String userName) {
        final List<FootballOAuth2AccessToken> oAuth2AccessTokens = mongoOAuth2AccessTokenRepository.findByUsernameAndClientId(userName, clientId);
    ...
    public Collection<OAuth2AccessToken> findTokensByClientId(final String clientId) {
        final List<FootballOAuth2AccessToken> oAuth2AccessTokens = mongoOAuth2AccessTokenRepository.findByClientId(clientId);
        return transformToOAuth2AccessTokens(oAuth2AccessTokens);
    }
    ...
    public OAuth2Authentication readAuthenticationForRefreshToken(final String value) {
        ...
        final FootballOAuth2RefreshToken mongoOAuth2RefreshToken = mongoOAuth2RefreshTokenRepository.findByTokenId(tokenId);
    ...
    private Collection<OAuth2AccessToken> transformToOAuth2AccessTokens(final List<FootballOAuth2AccessToken> oAuth2AccessTokens) {
